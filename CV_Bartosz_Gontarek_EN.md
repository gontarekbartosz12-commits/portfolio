...
**Brand Ambassador** — *British American Tobacco* · Feb – Jun 2025
- Product sales and loyalty sign-ups across HoReCa events; brand representation.

**Customer Advisor** — *Chic Sp. z o.o. (Inspiration Store), Warsaw* · Sep 2024 – Feb 2025
- Retail sales at Złote Tarasy; POS, stocktakes, loyalty, needs-based selling.

**Senior Sales Specialist & earlier sales roles** — *Viamind · BP Polska · M. Gabriel Consulting* · 2022 – 2024
- KPI-driven in-store & telesales; CRM + POS; e-commerce order handling (Allegro/OLX, BaseLinker, SkyShop).

## Certifications
| Certificate | Issuer | Verify |
|---|---|---|
| Claude Code in Action | Anthropic | verify.skilljar.com/c/if72ztiyp38p |
| Model Context Protocol: Advanced Topics | Anthropic | verify.skilljar.com/c/8xdbrzcy4xok |
| Introduction to Model Context Protocol | Anthropic | verify.skilljar.com/c/nuugdvuz6mdu |
| AI Fluency: Framework & Foundations | Anthropic | — |
| Teaching the AI Fluency Framework | Anthropic | — |
| AI Fluency — students / educators / nonprofits | Anthropic | — |
| AI Literacy | IBM SkillsBuild | credly.com/go/zJq0mS6y |
| AI Fundamentals: Foundations for Understanding AI | IBM SkillsBuild | credly.com/go/29skcRnf |
| AI Fundamentals: Language and Vision in AI | IBM SkillsBuild | credly.com/go/UpNXWOmf |
| Google Ads — Basic Marketing Online | Google | 2023 |

## Education
**General Secondary School** — LO im. W.S. Reymonta, Konstancin-Jeziorna · 2019 – 2022
Matura: extended English **98%** (CEFR ~B2/C1)

## Languages
Polish — Native · English — B2 (extended Matura 98%)
